...
nrx = 10; % number of x variables with random coefficients
ide_par = nrx+nrx*(nrx+1)*.5 ; % number of parameters
mean1 = reshape(.25:.75/(nrx-1):1,nrx,1);
A = [1.5	0.5	0.5	0.5	0.5	0.5	0.5	0.5	0.5	0.5
...
% Quadrature
Q_plan = xlsread('sim_plan_dq.xlsx','d=10');
...
save('NONdiag_10rand_output.mat')
